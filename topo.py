...
def topology():
    ...
    print(s1.cmd('iptables -t mangle -A INPUT --match mac --mac-source {} -j CLASSIFY --set-class 0:0'.format( h1.MAC() )))
    # class 1: traffic from h2
    print(s1.cmd('iptables -t mangle -A INPUT --match mac --mac-source {} -j CLASSIFY --set-class 0:1'.format( h2.MAC() )))
